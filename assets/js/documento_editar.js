...
document.addEventListener('DOMContentLoaded', function() {
    ...
    if (formApartado1) {
        ...
        formApartado1.addEventListener('submit', function(e) {
            ...
            fetch('/Pagina_Solicitudes3/documentos/procesar_apartado1.php', {
                method: 'POST',
                body: formData
            })
    ...
    if (formApartado2) {
        formApartado2.addEventListener('submit', function(e) {
            ...
            fetch('/Pagina_Solicitudes3/documentos/procesar_apartado2.php', {
                method: 'POST',
                body: formData
            })
            .then(response => response.json())
...
function completarDocumento(documentoId, boton) {
    ...
    fetch('/Pagina_Solicitudes3/documentos/procesar_completar.php', {
        method: 'POST',
        body: formData
    })
    .then(response => response.json())
